...
UPDATE_URL = "https://raw.githubusercontent.com/WrNekit/agent-updater/refs/heads/main/10.py"
...
def perform_update_sync(update_url):
    ...
    try:
        ...
        # Формируем имя файла с отметкой времени
        ...
        # Устанавливаем права на выполнение (попытка)
        try:
