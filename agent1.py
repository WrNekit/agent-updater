...
UPDATE_URL = "https://raw.githubusercontent.com/WrNekit/agent-updater/refs/heads/main/agent1.py"
...
def check_for_updates():
    ...
    logging.info("Checking for updates...")  # Явное логирование начала работы
    try:
